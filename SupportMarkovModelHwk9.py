import InputDataHw9P3 as Settings
...
def print_outcomes(simOutput, therapy_name):
    ...
    time_to_HIV_death_CI_text = F.format_estimate_interval(
        estimate=simOutput.get_sumStat_time_to_death().get_mean(),
        interval=simOutput.get_sumStat_time_to_death().get_t_CI(alpha=Settings.ALPHA),
        deci=2)
